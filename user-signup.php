	...
	<body class="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0F172A]">
		...
		<div class="relative z-10 w-full max-w-2xl px-6">
			...
			<div class="text-center mb-6 text-white">
				...
				<p class="text-sm text-slate-300">Create your freelance account</p>
			</div>
			...
			<form method="POST" action="api/freelancer.php" onsubmit="return validatePassword()" enctype="multipart/form-data">
				...
				<div id="step2" class="card hidden">
					...
					<div class="grid md:grid-cols-2 gap-4">
						...
						<input required name="education" class="input" placeholder="Education">
						<input required name="college" class="input" placeholder="College">
						<input required name="skills" class="input" placeholder="Skills">
				...
				<div id="step3" class="card hidden">
					...
					<div class="grid gap-4">
						<input name="rate" required type="number" class="input" placeholder="Hourly Rate (₹)">
