			...
			<div class="flex-1 flex flex-col overflow-hidden">
				...
				<header class="bg-gray-900 p-4 flex justify-between items-center">
					...
					<div class="flex items-center gap-3">
						...
						<h1 class="text-xl font-bold">Freelancer Management</h1>
					</div>
							...
							<tbody id="userTable" class="divide-y divide-gray-800">
								...
								?>
									<tr class="hover:bg-gray-800 transition">
										<td class="px-6 py-4">
											<img src="../public/assets/freelancer/<?php echo $d->profile_p;?>" class="w-10 h-10 rounded-full">
										</td>
										...
										<td class="px-6 py-4"><?php echo $d->education;?></td>
										<td class="px-6 py-4"><?php echo $d->skills;?></td>
									</tr>
								<?php
										}
									}
		...
		<script>
			function element(data){
				...
				let img = document.createElement("img");
					...
					img.setAttribute("src", `../public/assets/freelancer/${data.profile_p}`);
