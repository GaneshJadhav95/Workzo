...
<html lang="en">
	...
	<body class="bg-[#0F172A] text-slate-200 min-h-screen flex">
		...
		<main class="flex-1">
			...
			<!-- CONTENT -->
			<div class="p-6 space-y-10 max-w-4xl">
				...
				<form method="POST" id="setting">
					<section class="bg-[#020617] border border-slate-800 rounded-2xl p-6">
						...
						<div class="grid md:grid-cols-2 gap-4">
							<input required name="name" class="input" placeholder="Full Name">
							<input required name="email" class="input" placeholder="Email Address">
							<input required name="contact" class="input" placeholder="Phone Number">
					...
					<section class="bg-[#020617] border border-slate-800 rounded-2xl p-6">
						...
						<div class="grid md:grid-cols-2 gap-4">
							...
							<input type="password" class="input md:col-span-2" placeholder="Confirm New Password">
						</div>
		
						<button class="btn-primary mt-6">Update Password</button>
					</section>
